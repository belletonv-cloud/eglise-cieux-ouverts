...
@keyframes nr-circle-left {
  0%   { transform: translate(calc(-50% - 350px), calc(-50% - 150px)) scale(0.6); opacity: 0; }
  100% { transform: translate(-50%, -50%) scale(1.2); opacity: 1; }
}

@keyframes nr-circle-right {
  0%   { transform: translate(calc(-50% + 400px), calc(-50% + 80px)) scale(0.7); opacity: 0.1; }
  100% { transform: translate(-50%, -50%) scale(1.1); opacity: 0.9; }
}

@keyframes nr-circle-small {
  0%   { transform: translate(calc(-50% - 100px), calc(-50% + 200px)) scale(0.4); opacity: 0; }
...
@container (max-width: 600px) {
  .block-nous-rejoindre { padding: 30px 20px; min-height: 220px; }
